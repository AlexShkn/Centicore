...
import { otfToTtf, ttfToWoff, fontStyle } from './config/gulp-tasks/fonts.js'
import { video } from './config/gulp-tasks/video.js'
...
const buildTasks = gulp.series(
	...
	jsDev,
	js,
	gulp.parallel(html, css, images, gitignore, video),
)
